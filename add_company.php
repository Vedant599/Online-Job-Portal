...
<!--               <a class="btn btn-primary" href="add_customer.php">Add Customer</a> -->
    ...
    <span aria-hidden="true">&times;</span>
            ...
            <form name="Company_form" id="Company_form">
              ...
              <div class="form-group">
                <label for="Customer Username">Desctiption</label>
                <textarea name="Desctiption" id="Desctiption" class="form-control" cols="30" rows="10"></textarea> 
              </div>
    ...
    $('#customer_form').submit(function(){
      ...
      if(Desctiption==' '){
        alert("Please Enter Desctiption ");
        return false;
      }
      if(Company==' '){
      ...
      var data = $("#Compnay_form").serialize()
